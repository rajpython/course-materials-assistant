...
class TestRAGSystem:
    ...
    def test_query_content_search_success(self):
        ...
        result_response, result_sources = self.rag_system.query("What is MCP?", "session_123")
        ...
        assert call_args[1]['query'] == "Answer this question about course materials: What is MCP?"
    ...
    def test_query_with_conversation_history(self):
        ...
        result_response, result_sources = self.rag_system.query("Follow-up question", "session_123")
    ...
    def test_query_outline_request(self):
        ...
        self.mock_ai_generator.generate_response.return_value = "Course outline response"

        result_response, result_sources = self.rag_system.query("What is the outline of MCP course?")
    ...
    def test_sources_reset_after_query(self):
        ...
        self.rag_system.search_tool.last_sources = [{"text": "Test", "link": "http://test.com"}]
    ...
    def test_add_course_document_success(self):
        ...
        mock_course = Course(
            ...
            lessons=[Lesson(lesson_number=1, title="Lesson 1", lesson_link="http://test.com/1")]
        )
        ...
        self.mock_document_processor.process_course_document.assert_called_once_with("test_file.pdf")
    ...
    def test_add_course_document_error(self):
        ...
        self.mock_document_processor.process_course_document.side_effect = Exception("Processing failed")
    ...
    def test_add_course_folder_success(self):
        ...
        with patch('rag_system.os.path.exists') as mock_exists, \
            ...
            mock_course1 = Course(title="Course 1", instructor="Instructor 1", course_link="", lessons=[])
            mock_course2 = Course(title="Course 2", instructor="Instructor 2", course_link="", lessons=[])
    ...
    def test_add_course_folder_skip_existing(self):
        ...
        with patch('rag_system.os.path.exists') as mock_exists, \
            ...
            mock_course = Course(title="Existing Course", instructor="Test", course_link="", lessons=[])
            self.mock_document_processor.process_course_document.return_value = (mock_course, [Mock()])
    ...
    def test_add_course_folder_clear_existing(self):
        ...
        with patch('rag_system.os.path.exists') as mock_exists, \
            ...
            mock_course = Course(title="Course 1", instructor="Test", course_link="", lessons=[])
            self.mock_document_processor.process_course_document.return_value = (mock_course, [Mock()])
            self.mock_vector_store.get_existing_course_titles.return_value = []
    ...
    def test_error_handling_in_query(self):
        ...
        self.mock_ai_generator.generate_response.side_effect = Exception("AI API failed")
    ...
    def test_prompt_formatting(self):
        ...
        assert query_param == "Answer this question about course materials: What is Python?"
