...
# Frontend to FastAPI
create_arrow(
    ax, 2.5, 10.5, 4, 10.5, 'POST /api/query\n{"query": "...", "session_id": "..."}'
)
...
create_arrow(
    ax, 4, 10.2, 2.5, 10.2, 'JSON Response:\n{"answer": "...", "sources": [...]}'
)
...
ax.text(
    5, 7.2, "Need to\nsearch?", ha="center", va="center", fontsize=8, fontweight="bold"
)
...
plt.tight_layout()
plt.savefig(
    "/Users/rajpython/dev/ai-learning/claude-code-learning/starting-ragchatbot-codebase/query_flow_diagram.png",
    dpi=300,
    bbox_inches="tight",
    facecolor="white",
)
